...
class TestQueryBuilding:
    ...
    def test_basic_query_execution(self, mock_execute):
        ...
        mock_execute.return_value = [
            (1, 1, 'female', 29.0, 0, 0, 71.28, False, True, 'C', 'First', 'woman', 'B', 'Cherbourg', 'yes')
        ]
...
class TestValidationLogic:
    ...
    def test_age_validation(self):
        ...
        for age in valid_ages:
            passenger = PassengerResponse(
                survived=1, pclass=1, sex='female', age=age,
                sibsp=0, parch=0, fare=10.0, adult_male=False, alone=True
            )
    ...
    def test_class_validation(self):
        ...
        for pclass in valid_classes:
            passenger = PassengerResponse(
                survived=1, pclass=pclass, sex='female',
                sibsp=0, parch=0, fare=10.0, adult_male=False, alone=True
            )
    ...
    def test_sex_validation(self):
        ...
        for sex in valid_sexes:
            passenger = PassengerResponse(
                survived=1, pclass=1, sex=sex,
                sibsp=0, parch=0, fare=10.0, adult_male=(sex == 'male'), alone=True
            )
    ...
    def test_boolean_conversion(self):
        ...
        for input_val, expected in test_cases:
            passenger = PassengerResponse(
                ...
                sibsp=0, parch=0, fare=10.0, 
                adult_male=bool(input_val), alone=True
            )
